...
WPpenalized <- function(X_, Y_, power_, penalty_, groups_, unique_groups_, group_weights_, lambda_, nlambda_, lmin_ratio_, alpha_, gamma_, tau_, scale_factor_, penalty_factor_, opts_) {
    .Call('_limbs_WPpenalized', PACKAGE = 'limbs', X_, Y_, power_, penalty_, groups_, unique_groups_, group_weights_, lambda_, nlambda_, lmin_ratio_, alpha_, gamma_, tau_, scale_factor_, penalty_factor_, opts_)
}
