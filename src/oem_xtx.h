...
protected:
  ...
  //       
  //     }
  //     Rcpp::Rcout << "transf beta " << u(0,0) <<", ";
  //     Rcpp::Rcout << "Norms " << norms(0) <<", ";
  //     Rcpp::Rcout << "penalty " << lambda * penalty_factor(0) << ", ";
  //     Rcpp::Rcout << "thresh " << thresh(0)<<", ";
  //     beta = u.array().colwise() * thresh.array();
  //     Rcpp::Rcout << "beta thresh " << beta(0,0) <<", ";
  //     beta.array() /= denom;
  //     Rcpp::Rcout << "beta " << beta(0,0) <<"\n";
  //   } else {
