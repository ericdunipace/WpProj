...
RcppExport SEXP _limbs_sufficientStatistics(SEXP X_SEXP, SEXP Y_SEXP, SEXP theta_SEXP, SEXP options_SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _limbs_xtyUpdate(SEXP X_SEXP, SEXP Y_SEXP, SEXP theta_SEXP, SEXP result_SEXP, SEXP options_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type X_(X_SEXP);
...
// WPpenalized
SEXP WPpenalized(SEXP X_, SEXP Y_, SEXP theta_, SEXP power_, SEXP family_, SEXP penalty_, SEXP groups_, SEXP unique_groups_, SEXP group_weights_, SEXP lambda_, SEXP nlambda_, SEXP lmin_ratio_, SEXP alpha_, SEXP gamma_, SEXP tau_, SEXP scale_factor_, SEXP penalty_factor_, SEXP opts_);
RcppExport SEXP _limbs_WPpenalized(SEXP X_SEXP, SEXP Y_SEXP, SEXP theta_SEXP, SEXP power_SEXP, SEXP family_SEXP, SEXP penalty_SEXP, SEXP groups_SEXP, SEXP unique_groups_SEXP, SEXP group_weights_SEXP, SEXP lambda_SEXP, SEXP nlambda_SEXP, SEXP lmin_ratio_SEXP, SEXP alpha_SEXP, SEXP gamma_SEXP, SEXP tau_SEXP, SEXP scale_factor_SEXP, SEXP penalty_factor_SEXP, SEXP opts_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type X_(X_SEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type penalty_factor_(penalty_factor_SEXP);
    Rcpp::traits::input_parameter< SEXP >::type opts_(opts_SEXP);
    rcpp_result_gen = Rcpp::wrap(WPpenalized(X_, Y_, theta_, power_, family_, penalty_, groups_, unique_groups_, group_weights_, lambda_, nlambda_, lmin_ratio_, alpha_, gamma_, tau_, scale_factor_, penalty_factor_, opts_));
    return rcpp_result_gen;
END_RCPP
}
// cost_calculation_
...
// pbClean
void pbClean();
RcppExport SEXP _limbs_pbClean() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    pbClean();
    return R_NilValue;
...
RcppExport SEXP _limbs_selVarMeanGen(SEXP X_SEXP, SEXP theta_SEXP, SEXP beta_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _limbs_sinkhorn_(SEXP p_SEXP, SEXP q_SEXP, SEXP cost_matrix_SEXP, SEXP epsilonSEXP, SEXP niterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _limbs_transport_C_(SEXP mass_a_SEXP, SEXP mass_b_SEXP, SEXP cost_matrix_SEXP, SEXP method_SEXP, SEXP epsilon_SEXP, SEXP niter_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _limbs_transport_(SEXP A_SEXP, SEXP B_SEXP, SEXP pSEXP, SEXP ground_pSEXP, SEXP method_SEXP, SEXP a_sortSEXP, SEXP epsilon_SEXP, SEXP niter_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericMatrix& >::type A_(A_SEXP);
...
RcppExport SEXP _limbs_wasserstein_(SEXP mass_SEXP, SEXP cost_SEXP, SEXP pSEXP, SEXP from_SEXP, SEXP to_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _limbs_wasserstein_p_iid_(SEXP X_SEXP, SEXP Y_SEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP& >::type X_(X_SEXP);
...
RcppExport SEXP _limbs_wasserstein_p_iid_p_(SEXP X_SEXP, SEXP Y_SEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP& >::type X_(X_SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_limbs_WPpenalized", (DL_FUNC) &_limbs_WPpenalized, 18},
    ...
    {"_limbs_selVarMeanGen", (DL_FUNC) &_limbs_selVarMeanGen, 3},
    {"_limbs_sinkhorn_", (DL_FUNC) &_limbs_sinkhorn_, 5},
    {"_limbs_transport_C_", (DL_FUNC) &_limbs_transport_C_, 6},
    {"_limbs_transport_", (DL_FUNC) &_limbs_transport_, 8},
    {"_limbs_wasserstein_", (DL_FUNC) &_limbs_wasserstein_, 5},
    {"_limbs_wasserstein_p_iid_", (DL_FUNC) &_limbs_wasserstein_p_iid_, 3},
    {"_limbs_wasserstein_p_iid_p_", (DL_FUNC) &_limbs_wasserstein_p_iid_p_, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_limbs(DllInfo *dll) {
