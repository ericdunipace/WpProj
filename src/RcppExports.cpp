...
RcppExport SEXP _SparsePosterior_sufficientStatistics(SEXP X_SEXP, SEXP Y_SEXP, SEXP theta_SEXP, SEXP options_SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SparsePosterior_xtyUpdate(SEXP X_SEXP, SEXP Y_SEXP, SEXP theta_SEXP, SEXP result_SEXP, SEXP options_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type X_(X_SEXP);
...
RcppExport SEXP _SparsePosterior_cost_calculation_(SEXP A_SEXP, SEXP B_SEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// pbClean
void pbClean();
RcppExport SEXP _SparsePosterior_pbClean() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    pbClean();
    return R_NilValue;
...
// test
void test();
RcppExport SEXP _SparsePosterior_test() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    test();
    return R_NilValue;
...
RcppExport SEXP _SparsePosterior_selVarMeanGen(SEXP X_SEXP, SEXP theta_SEXP, SEXP beta_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SparsePosterior_sinkhorn_(SEXP p_SEXP, SEXP q_SEXP, SEXP cost_matrix_SEXP, SEXP epsilonSEXP, SEXP niterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SparsePosterior_transport_C_(SEXP mass_a_SEXP, SEXP mass_b_SEXP, SEXP cost_matrix_SEXP, SEXP method_SEXP, SEXP epsilon_SEXP, SEXP niter_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SparsePosterior_transport_(SEXP A_SEXP, SEXP B_SEXP, SEXP pSEXP, SEXP ground_pSEXP, SEXP method_SEXP, SEXP a_sortSEXP, SEXP epsilon_SEXP, SEXP niter_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericMatrix& >::type A_(A_SEXP);
...
RcppExport SEXP _SparsePosterior_wasserstein_(SEXP mass_SEXP, SEXP cost_SEXP, SEXP pSEXP, SEXP from_SEXP, SEXP to_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SparsePosterior_wasserstein_p_iid_(SEXP X_SEXP, SEXP Y_SEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP& >::type X_(X_SEXP);
...
RcppExport SEXP _SparsePosterior_wasserstein_p_iid_p_(SEXP X_SEXP, SEXP Y_SEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP& >::type X_(X_SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_SparsePosterior_sufficientStatistics", (DL_FUNC) &_SparsePosterior_sufficientStatistics, 4},
    {"_SparsePosterior_xtyUpdate", (DL_FUNC) &_SparsePosterior_xtyUpdate, 5},
    {"_SparsePosterior_W2penalized", (DL_FUNC) &_SparsePosterior_W2penalized, 17},
    {"_SparsePosterior_cost_calculation_", (DL_FUNC) &_SparsePosterior_cost_calculation_, 3},
    {"_SparsePosterior_pbClean", (DL_FUNC) &_SparsePosterior_pbClean, 0},
    {"_SparsePosterior_test", (DL_FUNC) &_SparsePosterior_test, 0},
    {"_SparsePosterior_selVarMeanGen", (DL_FUNC) &_SparsePosterior_selVarMeanGen, 3},
    {"_SparsePosterior_sinkhorn_", (DL_FUNC) &_SparsePosterior_sinkhorn_, 5},
    {"_SparsePosterior_transport_C_", (DL_FUNC) &_SparsePosterior_transport_C_, 6},
    {"_SparsePosterior_transport_", (DL_FUNC) &_SparsePosterior_transport_, 8},
    {"_SparsePosterior_wasserstein_", (DL_FUNC) &_SparsePosterior_wasserstein_, 5},
    {"_SparsePosterior_wasserstein_p_iid_", (DL_FUNC) &_SparsePosterior_wasserstein_p_iid_, 3},
    {"_SparsePosterior_wasserstein_p_iid_p_", (DL_FUNC) &_SparsePosterior_wasserstein_p_iid_p_, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_SparsePosterior(DllInfo *dll) {
